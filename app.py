...
if uploaded_file is not None:
    try:
        ...
        with col2:
            ...
            # Tính năng tách đường biểu đồ theo nhóm
                ...
                for col in selected_keys:
                    ...
                    for idx, row in working_df.iterrows():
                        ...
                        if val and val.lower() != 'nan':
                            # Xử lý chuỗi chứa nhiều mốc thời gian/giá trị bên trong
                            ...
                            if matches:
                                ...
                                # Xử lý chuỗi chỉ chứa giá trị số
